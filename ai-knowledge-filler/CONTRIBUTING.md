...
For a deeper module-by-module breakdown, see [ARCHITECTURE.md](Claude/projects/ai-factory/ai-knowledge-filler/ARCHITECTURE.md).
...
**Known issues** are documented in [ARCHITECTURE.md — Known Issues](Claude/projects/ai-factory/ai-knowledge-filler/ARCHITECTURE.md#known-issues). If you fix one, remove it from that section in the same PR.
...
AKF follows [Semantic Versioning 2.0.0](https://semver.org/). The public API is declared in [ARCHITECTURE.md](Claude/projects/ai-factory/ai-knowledge-filler/ARCHITECTURE.md).
