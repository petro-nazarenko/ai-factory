...
- [Architecture](Claude/projects/ai-factory/ai-knowledge-filler/ARCHITECTURE.md) — module map, data flow, pipeline decisions
- [CLI Reference](Claude/projects/ai-factory/ai-knowledge-filler/docs/cli-reference.md) — all commands, flags, exit codes
- [User Guide](user-guide.md) — installation, configuration, troubleshooting
- [REST API Threat Model](Claude/projects/ai-factory/ai-knowledge-filler/docs/rest-api-threat-model.md) — auth, endpoint exposure, limits, logging/PII
- [Contributing](Claude/projects/ai-factory/ai-knowledge-filler/CONTRIBUTING.md) — dev setup, quality gates, adding providers
