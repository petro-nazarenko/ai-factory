...
See [Error Codes](Error-Codes.md) for full descriptions and repair guidance.
...
See [REST API](REST-API.md) and [MCP Server](MCP-Server.md) for full details.
...
- [Error Codes](Error-Codes.md) — E001–E008 error code meanings
- [REST API](REST-API.md) — HTTP API reference
- [MCP Server](MCP-Server.md) — MCP integration guide
