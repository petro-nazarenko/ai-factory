...
Known issues are documented in [Architecture](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Architecture.md). If you fix one, remove it from that section in the same PR.
...
AKF follows [Semantic Versioning 2.0.0](https://semver.org/). The public API is declared in [Architecture](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Architecture.md).
...
`1.0.0` means the public API as declared in [Architecture](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Architecture.md) is stable.
...
- [Architecture](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Architecture.md) — module map and design decisions
- [CLI Reference](Claude/projects/ai-factory/ai-knowledge-filler/wiki/CLI-Reference.md) — all commands
- [Installation](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Installation.md) — dev environment setup
