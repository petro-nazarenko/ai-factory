...
See [Configuration](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Configuration.md) for the full schema reference.
...
Your `akf.yaml` taxonomy does not include the domain the LLM chose. Run `akf init` to regenerate the config, or add the domain manually. See [Error Codes](Error-Codes.md).

---

## Next Steps

- [Configuration](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Configuration.md) — customize `akf.yaml`
- [CLI Reference](Claude/projects/ai-factory/ai-knowledge-filler/wiki/CLI-Reference.md) — all available commands
- [Python API](Python-API.md) — use AKF programmatically
