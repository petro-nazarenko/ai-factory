...
- [CLI Reference](Claude/projects/ai-factory/ai-knowledge-filler/wiki/CLI-Reference.md) — `akf serve --mcp` command
- [REST API](REST-API.md) — HTTP API alternative
- [Installation](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Installation.md) — installing with MCP support
