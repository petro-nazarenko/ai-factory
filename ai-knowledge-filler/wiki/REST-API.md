...
For endpoint exposure and abuse analysis, see [REST API Threat Model](Claude/projects/ai-factory/ai-knowledge-filler/wiki/REST-API-Threat-Model.md).
...
- [CLI Reference](Claude/projects/ai-factory/ai-knowledge-filler/wiki/CLI-Reference.md) — `akf serve` command
- [MCP Server](MCP-Server.md) — MCP protocol server
- [Python API](Python-API.md) — Python SDK
