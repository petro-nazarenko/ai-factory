...
The config schema is versioned at `schema_version: "1.0.0"`. See [Configuration](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Configuration.md).

---

## Breaking Change Policy

Breaking changes to any public interface require a MAJOR version increment. See [Contributing](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Contributing.md) for the full versioning policy.
...
- [Configuration](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Configuration.md) — akf.yaml schema
- [Contributing](Claude/projects/ai-factory/ai-knowledge-filler/wiki/Contributing.md) — dev setup, adding providers
